...
public class ShadowTransformer_ implements ViewPager.OnPageChangeListener, ViewPager.PageTransformer {
    ...
    public ShadowTransformer_(ViewPager viewPager, CardAdapter adapter) {
